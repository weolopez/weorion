   ...
   function tooltips(){   
        ...
        $(".tooltips").each(function(){         
            ...
            $(this).poshytip({
                ...
                allowTipHover: false,
                bgImageFrameSize: 6,
                backgroundGradient: '../images/tip-white/backgroundwhite.gif',
                fade: true,
                slide: false
            });                         
        });
    ...
    $.fn.poshytip = function(options){
        ...
        if (!$('#poshytip-css-' + opts.className)[0])
            $(['<style id="poshytip-css-',opts.className,'" type="text/css">',
                ...
                'div.',opts.className,' div.tip-inner{background-image: url('+opts.backgroundGradient+') repeat scroll bottom left transparent;}',
