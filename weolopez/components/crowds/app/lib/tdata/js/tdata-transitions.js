...
//TODO Potential POPUP functionality
function tdataPopover(oldSpace, newSpace) {
   newSpace.parent().append('<div id="overlaybg" style="possition: absolute; top:100%,bottom:100%,right:100%,left:10%,height:100%;width:100%;background: #000;opacity:0.7;z-index:900;"></div>');
   newSpace.addClass('adOn').hide().css('visibility', 'visible').fadeIn();
}
